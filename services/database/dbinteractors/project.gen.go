...
func newProject(db *gorm.DB, opts ...gen.DOOption) project {
	...
	_project.Theme = field.NewString(tableName, "theme")
	_project.Year = field.NewInt32(tableName, "year")
	_project.SupervisorID = field.NewInt32(tableName, "supervisor_id")
	_project.StudentID = field.NewInt32(tableName, "student_id")
	_project.StatusID = field.NewInt32(tableName, "status_id")
	_project.RepoID = field.NewInt32(tableName, "repoId")
	_project.CloudDriveFolderID = field.NewString(tableName, "cloud_drive_folder_id")
...
func (p *project) updateTableName(table string) *project {
	...
	p.Theme = field.NewString(table, "theme")
	p.Year = field.NewInt32(table, "year")
	p.SupervisorID = field.NewInt32(table, "supervisor_id")
	p.StudentID = field.NewInt32(table, "student_id")
	p.StatusID = field.NewInt32(table, "status_id")
	p.RepoID = field.NewInt32(table, "repoId")
...
func (p *project) fillFieldMap() {
	...
	p.fieldMap["id"] = p.ID
	p.fieldMap["theme"] = p.Theme
	p.fieldMap["year"] = p.Year
	p.fieldMap["supervisor_id"] = p.SupervisorID
	p.fieldMap["student_id"] = p.StudentID
	p.fieldMap["status_id"] = p.StatusID
	p.fieldMap["repoId"] = p.RepoID
