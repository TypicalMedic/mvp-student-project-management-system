...
func newStudent(db *gorm.DB, opts ...gen.DOOption) student {
	...
	_student.Surname = field.NewString(tableName, "surname")
	_student.MiddleName = field.NewString(tableName, "middle_name")
	_student.UniGroup = field.NewString(tableName, "uni_group")
...
func (s *student) updateTableName(table string) *student {
	...
	s.Surname = field.NewString(table, "surname")
	s.MiddleName = field.NewString(table, "middle_name")
	s.UniGroup = field.NewString(table, "uni_group")
...
func (s *student) fillFieldMap() {
	...
	s.fieldMap["surname"] = s.Surname
	s.fieldMap["middle_name"] = s.MiddleName
	s.fieldMap["uni_group"] = s.UniGroup
}
